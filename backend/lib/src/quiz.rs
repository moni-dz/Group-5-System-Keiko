...
/// GET /v1/quiz
async fn get_quizzes<S: QuizAPI>(stack: web::Data<S>) -> HttpResponse {
...
async fn get_quiz<S: QuizAPI>(quiz_id: web::Path<Uuid>, stack: web::Data<S>) -> HttpResponse {
...
/// GET /v1/quiz/ongoing
async fn get_ongoing_quizzes<S: QuizAPI>(stack: web::Data<S>) -> HttpResponse {
...
async fn get_completed_quizzes<S: QuizAPI>(stack: web::Data<S>) -> HttpResponse {
...
/// POST /v1/quiz
async fn create_quiz<S: QuizAPI>(
    create_quiz: web::Json<CreateQuiz>,
    stack: web::Data<S>,
) -> HttpResponse {
...
/// PUT /v1/quiz
async fn update_quiz<S: QuizAPI>(quiz: web::Json<Quiz>, stack: web::Data<S>) -> HttpResponse {
...
async fn delete_quiz<S: QuizAPI>(quiz_id: web::Path<Uuid>, stack: web::Data<S>) -> HttpResponse {
